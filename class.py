...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.player_float = [player_float_1,player_float_2,player_float_3,player_float_4]
        self.player_index = 0
        self.player_jump = pygame.image.load(r"C:\python\game assets\astronaut_2.png").convert_alpha()

        self.image = self.player_float[self.player_index]
        self.rect = self.image.get_rect(midbottom = (100,300))
        self.gravity = 0

        self.jump_sound = pygame.mixer.Sound(r'C:\python\game assets\jump.mp3')
    ...
    def animation_state(self):
        if self.rect.bottom < 300:
            ...
            if self.player_index >= len(self.player_float): self.player_index = 0
            self.image = self.player_float[int(self.player_index)] 
...
class Obstacles(pygame.sprite.Sprite):
    def __init__(self,type) -> None:
        ...
        if type == "ship":
            ...
            self.frame = [ship_frame_1,ship_frame_2]
            y_pos = 210
        else :
            ...
            self.frame = [alien_frame_1,alien_frame_2]
            y_pos = 300
...
def collision_sprite():
    dead_music = pygame.mixer.Sound(r'C:\python\game assets\ending.mp3')
    if pygame.sprite.spritecollide(player.sprite,obstecle_group,False):
        dead_music.play()
        obstecle_group.empty()
        return False
    else: return True
...
obstecle_group = pygame.sprite.Group()
...
bg_music = pygame.mixer.Sound(r'C:\python\game assets\background.mp3')
...
while True :
    for event in pygame.event.get():
        ...
        if game_active:
            if event.type == obstecle_timer :
                obstecle_group.add(Obstacles(choice(['alien','ship','alien','alien'])))
                # if randint(0,2):
    ...
    if game_active :
        ...
        obstecle_group.draw(screen)
        obstecle_group.update()
