...
while True :
    for event in pygame.event.get():
        ...
        # if event.type == pygame.MOUSEMOTION:     # gives the coords of mouse when moved,butwton gets pressed,released
        #     event_p = print(event.pos)        # prints mouse coords
    ...
    # if player_r.colliderect(alien_r):       # checking for collision
    #     print("collide")

    # mouse_pos = pygame.mouse.get_pos()      # getiing mouse position 
    # if player_r.collidepoint(mouse_pos):        # checking mouse collision
    #     print("collision")      # prints collurssor placed on the player
    #     print(pygame.mouse.get_pressed())    # returns true if the mouse buttons gets pressed
